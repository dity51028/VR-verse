                ...
                pricingOptions.map((price,index)=>{
                    return <div key={index} className='w-full sm:w-1/2 lg:w-1/3 p-2'>
                        <div className='p-10 border border-neutral-400 rounded-xl'>
                            ...
                            <a href="#" className='inline-flex justify-center  item-center text-center w-full h-12 p-2 mt-20 tracking-tighter text-xl hover:bg-orange-900 border border-orange-900 rounded-lg transition duration-200'>
                                Subscribe
                            </a>
                        </div>
                    </div>
